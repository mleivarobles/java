...
public class JIM_Reporte extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jcbxEquipos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar TipoEquipo", "Laptop", "Desktop" }));
        ...
        jtblReportes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tipo", "Modelo", "Nombre", "Telefono", "Correo", "Precio", "Año Venta"
            }
        ) {
    ...
    private void llenarTabla(){
        ...
        ArrayList<Reporte> lista = DAOVenta.listarVentas();
        tabla.setRowCount(0);
            
        String modelo, nombre, correo, tipoEquipo;
        int telefono;
        double precio;
        Date fecha;
        ...
        for (Reporte r : lista) {
            ...
            if(jcbxEquipos.getSelectedIndex() == 0){
                //sin filtro de año
                if(jcbxAnio.getSelectedIndex() == 0){
                    tabla.addRow(new Object[]{tipoEquipo, modelo, nombre, telefono, correo, precio, fechaS});
                    cantVentas++;
                    totalVentas +=precio;
                //con filtro de año
            ...
            //con filtro de equipo
                ...
                if(tipoEquipo.equalsIgnoreCase(tipo) && (jcbxAnio.getSelectedIndex() == 0)){
                    tabla.addRow(new Object[]{tipoEquipo, modelo, nombre, telefono, correo, precio, fechaS});
                    cantVentas++;
                    totalVentas +=precio;
                //con filtro de año
                }else if(anioVenta == Integer.parseInt(fechaS) 
                        && tipoEquipo.equalsIgnoreCase(tipo)){
                    tabla.addRow(new Object[]{tipoEquipo, modelo, nombre, telefono, correo, precio, fechaS});
                    cantVentas++;
                    totalVentas +=precio;
                }
