 ...
 * @author mario
 */
public class JIM_Venta extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jcbxEquipos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jcbxEquipos, 0, 160, Short.MAX_VALUE)
    ...
    private boolean validarCampos(){
        return !(jtxtRut.getText().isBlank() ||
                jcbxEquipos.getSelectedIndex() == 0
                );
    }
    
    private void limpiarCampos(){
        this.jtxtRut.setEnabled(true);
        this.jcbxEquipos.setEnabled(false);
    ...
    private void jbtbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtbBuscarActionPerformed
        ...
        if(!this.jtxtRut.getText().isBlank()){
            ...
            if( cliente != null ){
                ...
                this.jcbxEquipos.setEnabled(true);
            }else{
    ...
    private Venta getVenta(){
        if (validarCampos()){
            ...
            String codigo = (String)jcbxEquipos.getSelectedItem();
    ...
    private void llenarVehiculos(){
        this.jcbxEquipos.removeAllItems();
        jcbxEquipos.addItem("Seleccionar");
        ArrayList<String> lista = DAOEquipo.listarEquipos();
        for (String item : lista) {
            jcbxEquipos.addItem(item);
        }
    }
